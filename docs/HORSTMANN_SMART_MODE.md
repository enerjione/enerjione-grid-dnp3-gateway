...
| `DNP3_TIME_SYNC` | gateway `.env` | `lan` | Zaman senkronizasyon **proseduru**: `lan` \| `nonlan` \| `none`. **Horstmann filosunda `nonlan` VERIN** — bkz. §6b. Gecersiz deger boot'ta REDDEDILIR. |
